...
## Results
Seems to learn within +/- 5%.   Sample room shown in the picture (red=target, green=predicted), used a training set of 200,000 random (simulated) rooms.  It even learns to sort the freqs in (mostly) ascending order.
